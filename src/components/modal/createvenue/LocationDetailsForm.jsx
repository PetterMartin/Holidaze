...
const LocationDetailsForm = ({ formData, handleChange, handlePositionChange }) => {
  ...
  return (
    <div>
      <h1 className="text-2xl font-semibold text-gray-800">Where are you located?</h1>
      ...
      <div className="flex flex-col">
        <div className="h-40 md:h-96 overflow-hidden">
          <GeoMap onPositionChange={handlePositionChange} handleSearch={handleSearch} />
        </div>
        {/* Display latitude and longitude only if search button is clicked */}
        {searchClicked && (
          <div className="flex justify-between gap-4">
            <div className="flex gap-1 text-sm">
              <label className="block text-neutral-800 mb-1">Latitude</label>
            ...
            <div className="flex gap-1 text-sm">
              <label className="block text-neutral-800 mb-1">Longitude</label>
              {/* Hidden input field with actual value */}
              <input
                type="number"
                name="lng"
